...
namespace ComissionBank.Controllers
{
    public class TestesController : Controller
    {
        ...
        public TestesController(ComissionBankContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Idade,Email")] Teste teste)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Idade,Email")] Teste teste)
        {
            if (id != teste.Id)
            {
                return NotFound();
